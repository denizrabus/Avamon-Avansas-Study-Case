...
export const pokemonTypeLabels: Record<PokemonTypeName, string> = {
  bug: 'Bug',
  dark: 'Dark',
  dragon: 'Dragon',
  electric: 'Electric',
...
export const pokemonTypeBadgeClasses: Record<PokemonTypeName, string> = {
...
export const pokemonTypeRowBackgroundClasses: Record<PokemonTypeName, string> =
  {
